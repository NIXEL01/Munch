...
import com.example.munch.BuildConfig.PSTK_PUBLIC_KEY
...
class CheckoutActivity : AppCompatActivity() {
    ...
    private fun initializePaystack() {
        ...
        PaystackSdk.setPublicKey(com.example.munch.BuildConfig.PSTK_PUBLIC_KEY)
    }
    ...
    private fun performCharge() {
        ...
        var amount = intent.getIntExtra("totalPrice", 0)
        amount *= 100
