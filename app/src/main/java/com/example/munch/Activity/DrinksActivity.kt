...
import com.example.munch.Adapter.DrinksAdapter
...
class DrinksActivity : AppCompatActivity(), IDrinkLoadListener, ICartLoadListener{
    ...
    private lateinit var list: List<DrinksAdapter>
    ...
    override fun onDrinkLoadSuccess(DrinksList: List<Drinks>?) {
        val adapter = DrinksAdapter(this, DrinksList!!, cartLoadListener)
