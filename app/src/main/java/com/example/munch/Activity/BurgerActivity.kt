...
import com.example.munch.Adapter.BurgerAdapter
...
class BurgerActivity : AppCompatActivity(),IDrinkLoadListener,ICartLoadListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        product_Tv.setText("Burger").toString()
    }
    ...
    override fun onDrinkLoadSuccess(DrinksList: List<Drinks>?) {
        val adapter = BurgerAdapter(this, DrinksList!!, cartLoadListener)
